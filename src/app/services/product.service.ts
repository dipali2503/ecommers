...
export class ProductService {
  public cartAddedTosubject = new Subject<boolean>();
  public isLogin = new BehaviorSubject<boolean>(false);
  public isLoginAdmin = new BehaviorSubject<boolean>(false);
  public totalItems = new BehaviorSubject<number>(0);
  public productCartList = new BehaviorSubject<any>([])
  cartProducts: any[] = [];
  public selectedProduct = new BehaviorSubject<any>([])
...
},
{
  ...
  //   );
  // }
  // getCartItemByCustomerId( custId:number) : Observable<any[]> {
  //   debugger;
...
// returning cartProduct getCartProducts
